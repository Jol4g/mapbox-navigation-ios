...
extension UIColor {
    ...
    class var transparent: UIColor {  colorLiteral(red: 0.9023908973, green: 1, blue: 0.9093615413, alpha: 0) }

    class var defaultTintColor: UIColor {  colorLiteral(red: 0.1493228376, green: 0.2374534607, blue: 0.333029449, alpha: 1) }
    ...
    class var defaultBackgroundColor: UIColor {  colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.7) }
